...
public class SelfPlayTest {
    ...
    public void distributionOfTokensOnCapturedCells() {
        ...
        Assert.assertTrue(player.getCountTokens() == 0 && board.getBoardElements(0, 0).getCountTokens() == 3
    ...
    public void takingTokensInHand() {
        ...
        Assert.assertTrue(player.getCountTokens() == 4 && board.getBoardElements(0, 0).getCountTokens() == 1
                && board.getBoardElements(0, 1).getCountTokens() == 1);
    }
