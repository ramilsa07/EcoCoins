...
public class CaptureEmptyRegionsTest {
    ...
    public void capturingWaterForAmphibia() {
        ...
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 5
                && board.getBoardElements(0, 0).getBelongs() == player
    ...
    public void capturingMountedForAmphibia() {
        createBoard();
        player.changeRace(new Amphibia());
        playerService.regionCapture(board.getBoardElements(0, 1), player);
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 3
                && board.getBoardElements(0, 1).getBelongs() == player
                && board.getBoardElements(0, 1).getCountTokens() == 3);
    }
    ...
    public void capturingMountedForOrcs() {
        ...
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 3
                && board.getBoardElements(0, 1).getBelongs() == player
                && board.getBoardElements(0, 1).getCountTokens() == 2);
    }
    ...
    public void capturingMushroomsForAmphibia() {
        createBoard();
        player.changeRace(new Amphibia());
        playerService.regionCapture(board.getBoardElements(0, 2), player);
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 4
                && board.getBoardElements(0, 2).getBelongs() == player
                && board.getBoardElements(0, 2).getCountTokens() == 2);
    }
    ...
    public void capturingMushroomsForOrcs() {
        ...
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 4
                && board.getBoardElements(0, 2).getBelongs() == player
                && board.getBoardElements(0, 2).getCountTokens() == 1);
    }
    ...
    public void capturingEarthForAmphibia() {
        ...
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 4
                && board.getBoardElements(2, 2).getBelongs() == player
                && board.getBoardElements(2, 2).getCountTokens() == 2);
    }
    ...
    public void capturingEarthForOrcs() {
        ...
        Assert.assertTrue(player.getLocationCell().size() != 0 && player.getCountTokens() == 4
                && board.getBoardElements(2, 2).getBelongs() == player
                && board.getBoardElements(2, 2).getCountTokens() == 1);
    }
